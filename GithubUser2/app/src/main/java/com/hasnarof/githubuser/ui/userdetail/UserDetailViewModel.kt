        ...
        client.enqueue(object : Callback<List<FollowersResponse>> {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    response?.forEach {
                        convertedFollowers.add(User(it?.login, it?.avatarUrl, it?.followersUrl, it?.followingUrl))
                    }
        ...
        client.enqueue(object : Callback<List<FollowingResponse>> {
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    response?.forEach {
                        convertedFollowing.add(User(it?.login, it?.avatarUrl, it?.followersUrl, it?.followingUrl))
                    }
